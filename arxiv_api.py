...
class ArxivAPIWrapper(BaseModel):
    ...
    def validate_environment(cls, values: Dict) -> Dict:
        ...
        try:
            ...
            values["arxiv_newest"] = arxiv.SortCriterion.SubmittedDate
            values["arxiv_sort_order"] = arxiv.SortOrder.Descending
        except ImportError:
            raise ValueError(
    ...
    def run(self, query: str) -> str:
        ...
        try:
            docs = [
                ...
                # , sort_by=self.arxiv_newest, sort_order=self.arxiv_sort_order
            ]
